...
function pageHtml(c) {
    ...
    b.push('</ul>\n<ul class="pagination">\n');
    b.push('<li class="disabled controls" title="' + $.jgrid.pageTitle + '">' + $.jgrid.extend.pageLabelA + " ");
    b.push('<input type="text" value="' + c.pageNo + '" onkeypress="var e=window.event||event;var c=e.keyCode||e.which;if(c==13)');
    b.push(c.funcName + "(this.value," + c.pageSize + ",'" + c.funcParam + '\');" onclick="this.select();"/> ' + $.jgrid.extend.pageLabelB + " ");
    b.push('<input type="text" value="' + c.pageSize + '" onkeypress="var e=window.event||event;var c=e.keyCode||e.which;if(c==13)');
    b.push(c.funcName + "(" + c.pageNo + ",this.value,'" + c.funcParam + '\');" onclick="this.select();"/> ');
    b.push($.jgrid.format($.jgrid.extend.pageLabelC, c.count));
    b.push((c.pageInfo && c.pageInfo != "" ? c.pageInfo : "") + "</li>\n");
    b.push("</ul>\n");
