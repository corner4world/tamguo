...
public class PaperCrawler {
	...
	// 230000 黑龙江 | 610000 陕西 | 360000 江西 | 440000 广东 | 430000 湖南 | 460000 海南 | 530000 云南
	private final String AREA_ID = "530000";
	// 年份
	private final String YEAR = "2015";
	// 真题试卷             类型(1:真题试卷,2:模拟试卷,3:押题预测,4:名校精品)
	private final String PAPER_TYPE = "3";
	// 开始采集的URL
	private final String START_URL = "https://tiku.baidu.com/tikupc/paperlist/1bfd700abb68a98271fefa04-16-2-2015-1597-1-download";
