...
public class PaperCrawler {
	...
	private final String AREA_ID = "120000";
	// 年份
	private final String YEAR = "2016";
	// 真题试卷             类型(1:真题试卷,2:模拟试卷,3:押题预测,4:名校精品)
	private final String PAPER_TYPE = "2";
	// 开始采集的URL
	private final String START_URL = "https://tiku.baidu.com/tikupc/paperlist/1bfd700abb68a98271fefa04-20-4-2016-211-1-download";
